...
Neighbor Status Codes: m - Under maintenance
  ...
  spine1                   192.0.255.1      4 65001           2107      2115    0    0    1d05h Estab   12     12
  spine2                   192.0.255.2      4 65001           2111      2097    0    0    1d05h Estab   12     12
```
## show interfaces description

```
Interface                      Status         Protocol           Description
Et1                            up             up                 P2P_LINK_TO_SPINE1_Ethernet1
Et2                            up             up                 P2P_LINK_TO_SPINE2_Ethernet1
Et3                            up             up                 MLAG_PEER_leaf2_Ethernet3
Et4                            up             up                 
...
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor         V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  leaf2                    10.255.251.1     4 65101           2083      2087    0    0    1d05h Estab   7      7
  spine1_Ethernet1         172.31.255.0     4 65001           2084      2079    0    0    1d05h Estab   4      4
  spine2_Ethernet1         172.31.255.2     4 65001           2080      2082    0    0    1d05h Estab   4      4
```
...
```
Last table change time   : 1 day, 5:27:04 ago
...
---------- ------------------------ ---------------------- ---
Et1           spine1.lab.net           Ethernet1           120
Et2           spine2.lab.net           Ethernet1           120
Et3           leaf2.lab.net            Ethernet3           120
Et4           leaf2.lab.net            Ethernet4           120
Et5           host1                    Ethernet1           120
...
Arista cEOSLab
Hardware version: 
Serial number: 7D674C2785EC4F3BFED6163867A83079
Hardware MAC address: 001c.735e.1caa
System MAC address: 001c.735e.1caa
