...
Neighbor Status Codes: m - Under maintenance
  ...
  leaf1                    192.0.255.129    4 65101           2097      2111    0    0    1d05h Estab   6      6
  leaf2                    192.0.255.130    4 65101           2106      2108    0    0    1d05h Estab   6      6
  leaf3                    192.0.255.131    4 65102           2117      2103    0    0    1d05h Estab   6      6
  leaf4                    192.0.255.132    4 65102           2104      2114    0    0    1d05h Estab   6      6
```
## show interfaces description

```
Interface                      Status         Protocol           Description
Et1                            up             up                 P2P_LINK_TO_LEAF1_Ethernet2
Et2                            up             up                 P2P_LINK_TO_LEAF2_Ethernet2
Et3                            up             up                 P2P_LINK_TO_LEAF3_Ethernet2
Et4                            up             up                 P2P_LINK_TO_LEAF4_Ethernet2
...
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor         V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  leaf1_Ethernet2          172.31.255.3     4 65101           2082      2080    0    0    1d05h Estab   3      3
  leaf2_Ethernet2          172.31.255.7     4 65101           2090      2076    0    0    1d05h Estab   3      3
  leaf3_Ethernet2          172.31.255.11    4 65102           2080      2074    0    0    1d05h Estab   3      3
  leaf4_Ethernet2          172.31.255.15    4 65102           2086      2085    0    0    1d05h Estab   3      3
```
...
---------- ------------------------ ---------------------- ---
Et1           leaf1.lab.net            Ethernet2           120
Et2           leaf2.lab.net            Ethernet2           120
Et3           leaf3.lab.net            Ethernet2           120
Et4           leaf4.lab.net            Ethernet2           120
...
Arista cEOSLab
Hardware version: 
Serial number: E114574F15560BA2C86FA3B3923C8FEE
Hardware MAC address: 001c.731b.fec6
System MAC address: 001c.731b.fec6
