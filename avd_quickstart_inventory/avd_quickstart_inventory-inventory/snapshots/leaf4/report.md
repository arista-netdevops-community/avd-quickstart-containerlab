...
Router identifier 192.0.255.132, local AS number 65102
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor         V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  spine1                   192.0.255.1      4 65001           2114      2099    0    0    1d05h Estab   12     12
  spine2                   192.0.255.2      4 65001           2114      2104    0    0    1d05h Estab   12     12
```
## show interfaces description

```
Interface                      Status         Protocol           Description
Et1                            up             up                 P2P_LINK_TO_SPINE1_Ethernet4
Et2                            up             up                 P2P_LINK_TO_SPINE2_Ethernet4
Et3                            up             up                 MLAG_PEER_leaf3_Ethernet3
Et4                            up             up                 
...
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor         V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  leaf3                    10.255.251.4     4 65102           2076      2092    0    0    1d05h Estab   7      7
  spine1_Ethernet4         172.31.255.12    4 65001           2088      2084    0    0    1d05h Estab   4      4
  spine2_Ethernet4         172.31.255.14    4 65001           2085      2087    0    0    1d05h Estab   4      4
```
...
Loopback0       192.0.255.132/32      up         up             65535          
...
```
Last table change time   : 1 day, 5:27:13 ago
...
---------- ------------------------ ---------------------- ---
Et1           spine1.lab.net           Ethernet4           120
Et2           spine2.lab.net           Ethernet4           120
Et3           leaf3.lab.net            Ethernet3           120
Et4           leaf3.lab.net            Ethernet4           120
Et5           host2                    Ethernet2           120
...
! device: leaf4 (cEOSLab, EOS-4.27.0F-24305004.4270F (engineering build))
!
no aaa root
!
...
Arista cEOSLab
Hardware version: 
Serial number: A3C1AAD02788B6501B3758BB6A437728
Hardware MAC address: 001c.7314.d4c8
System MAC address: 001c.7314.d4c8
