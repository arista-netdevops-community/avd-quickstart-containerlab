# The content of this Dockerfile is taken from /tmp/vsch/updateUID.Dockerfile-0.231.4 generated by VSCode to change UID in devcontainer
# All credits to https://github.com/microsoft/vscode-remote-release
ARG BASE_IMAGE
FROM $BASE_IMAGE
